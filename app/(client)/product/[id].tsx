...
export default function ProductDetailScreen() {
    ...
    // Trouver le produit dans les données fictives
    ...
    if (!plat) {
        return (
            <View style={s.center}>
                ...
                <TouchableOpacity onPress={() => router.back()}><Text>Retour</Text></TouchableOpacity>
            </View>
        );
    }
...
const s = StyleSheet.create({
    ...
    productName: { fontSize: 24, fontWeight: '800', marginBottom: 8 },
